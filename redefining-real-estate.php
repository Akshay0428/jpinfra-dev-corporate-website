...
<section class="banner-wws">
   <img src="img/redevelopment/Banner-redevelopment.jpg" alt="banner" class="m_hide">
   <img src="img/redevelopment/Redevelopment-Projects-Banner-mob.jpg" alt="banner" class="d_hide">
</section>
